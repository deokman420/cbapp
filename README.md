...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v4.0.1)
...
```
cbapp/
├── cbapp.html          # The complete application (v4.0.1)
...
**CB App v4.0.1** — A self-contained productivity workspace that just works.
