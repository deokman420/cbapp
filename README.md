...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v4.0.3)
...
```
cbapp/
├── cbapp.html          # The complete application (v4.0.3)
...
**CB App v4.0.3** — A self-contained productivity workspace that just works.
