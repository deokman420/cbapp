...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.6)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.6)
...
**CB App v3.2.6** — A self-contained productivity workspace that just works.
