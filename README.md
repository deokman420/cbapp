...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.13)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.13)
...
**CB App v3.2.13** — A self-contained productivity workspace that just works.
