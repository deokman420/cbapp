...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.5)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.5)
...
**CB App v3.2.5** — A self-contained productivity workspace that just works.
