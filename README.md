...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.4)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.4)
...
**CB App v3.2.4** — A self-contained productivity workspace that just works.
