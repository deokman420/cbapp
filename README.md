...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v4.0.5)
...
```
cbapp/
├── cbapp.html          # The complete application (v4.0.5)
...
**CB App v4.0.5** — A self-contained productivity workspace that just works.
