...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.12)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.12)
...
**CB App v3.2.12** — A self-contained productivity workspace that just works.
