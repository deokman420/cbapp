...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.14)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.14)
...
**CB App v3.2.14** — A self-contained productivity workspace that just works.
