...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v4.0.2)
...
```
cbapp/
├── cbapp.html          # The complete application (v4.0.2)
...
**CB App v4.0.2** — A self-contained productivity workspace that just works.
