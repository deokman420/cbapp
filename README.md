...
- **Primary file:** [`cbapp.html`](cbapp.html) — The complete application (v3.2.18)
...
```
cbapp/
├── cbapp.html          # The complete application (v3.2.18)
...
**CB App v3.2.18** — A self-contained productivity workspace that just works.
